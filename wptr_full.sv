...
module wptr_full #(parameter ADDRSIZE = 4)
 (
    ...
    input  logic [ADDRSIZE :0]  wq2_rptr_ae,
    ...
    // Threshold in Gray code: distance from the full condition.
    localparam logic [ADDRSIZE:0] ALMOST_FULL = (ADDRSIZE == 2) ? 1 : ((1 << ADDRSIZE) / 4);
    ...
    always_comb begin
        ...
        wbin_ae_next = wbinnext - ALMOST_FULL;
    ...
    always_comb begin
        ...
        almost_wfull_val   = winc & (wgraynext == {~wq2_rptr_ae[ADDRSIZE:ADDRSIZE-1], wq2_rptr_ae[ADDRSIZE-2:0]});
    end
    always_ff @(posedge wclk or negedge wrst_n)
